...
export default function LoginPage() {
    ...
    async function handleSubmit(event: FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            setMessageType("error");
            setMessage(
                "No fue posible conectar con Supabase. Revisa la configuración del proyecto.",
            );
        } finally {
            setIsLoading(false);
        }
                    ...
                    <div className="p-8 sm:p-10 lg:p-12">
                        ...
                        <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
                            ...
                            {message && (
                                <p
                                    aria-live="polite"
                                    className={`border-l-4 bg-kam-gray px-4 py-3 text-sm leading-5 ${messageType === "success"
